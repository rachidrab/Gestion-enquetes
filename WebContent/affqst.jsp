                                ...
                                <div class="col-xs-6 col-sm-4 col-md-3 portfolio-item branded logos">
                                        <div class="portfolio-wrapper">
                                                    ...
                                                    <div class="form-group">
                                                            <input type="hidden" name="iq" value="${q.getIdQues}">
                                                            <input type="hidden" name="nm" value="${nm}">
                                                        <div class="portfolio-info ">      
                                                       <h1> <c:out value="${q.titre}" /> </h1>
                                                    </div></div>
                                            
                                            <div class="form-group">
                                                    <c:forEach var="op" items="${o}">
                                                    <div>
                                                            <input type="checkbox" name="listeo" value="${op.ido}">
                                                            <label for="${op.titre}"><c:out value="${op.titre}"/></label>
                                                          </div></c:forEach>
                        ...
                        <c:if test="${t == '4'}">
                            <div class="col-xs-6 col-sm-4 col-md-3 portfolio-item branded logos">
                                <div class="portfolio-wrapper">
                                    ...
                                    <c:forEach var="op" items="${o}">
                                    <div>
                                            <input type="radio" name="choix" value="${op.titre}">
                                             <label for="${op.titre}"><c:out value="${op.titre}"/></label> <!--Titre de l'enq-->
                                   </div>
                                    </c:forEach> </div>
                                </div>
                            </div>
               ...
               <c:if test="${t == '1'}">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 portfolio-item branded logos">
                            <div class="portfolio-wrapper">
                                ...
                                <c:forEach var="op" items="${o}">
                                        <div class="form-group">
                                                <input type="text" name="rp" class="form-control" required="required" placeholder="Votre Réponse">
                                            </div>
                                </c:forEach> </div>
                            </div>
                        </div>
